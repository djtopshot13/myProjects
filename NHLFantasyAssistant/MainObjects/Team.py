class Team:
    def __init__(self, division_id, team_id, name, players, points_for, points_against, points_diff, matchup_wins, matchup_losses, draft_list, stats_dict):
        ...
        self.stat_key_dict = {'W': "Goalie Wins", 'SO': "Shutouts", 'OTL': "Goalie Overtime Losses", 'L': "Goalie Losses",
                         'SV': "Saves", 'GA': "Goals Against", 'G&A': "Goals and Assists", 'G': "Goals", 'A': "Assists",
                         'PPP': "Power Play Points", 'PPG': "Power Play Goals", 'PPA':  "Power Play Assists", 
                         'SHP': "Short-Handed Points", 'SHG': "Short-Handed Goals", 'SHA': "Short-Handed Assists", 
                         'BLK': "Blocked Shots",'HIT': "Hits", 'SOG': "Shots on Goal", 'SA': "Shot Attempts", 'FOW': "Faceoffs Won",  '+/-': "+/-"}
    ...
    def getStatName(self, stat):
        ...
        stat_alias = self.stat_key_dict[stat]
