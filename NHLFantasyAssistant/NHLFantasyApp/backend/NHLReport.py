...
def main():
    ...
    # print()
    league_object.streakReport(team="free_agents", position="goalie", streak_type="warm", min_threshold=1.4)
    print()
    league_object.streakReport(team="Shortcake Miniture Schnauzers")
    print()
